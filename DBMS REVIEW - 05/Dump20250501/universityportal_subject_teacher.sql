...
CREATE TABLE `subject_teacher` (
  ...
  CONSTRAINT `subject_teacher_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`)
...
INSERT INTO `subject_teacher` VALUES (3,1),(8,1),(1,2),(5,2),(10,2),(2,3),(6,3),(4,4),(9,4),(7,5);
